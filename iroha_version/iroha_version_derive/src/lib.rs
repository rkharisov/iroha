...
fn impl_version(
    ...
    quote!(
        ...
        #[derive(iroha_introspect::Introspect, Debug, Clone, #scale_derives #json_derives)]
...
fn impl_declare_versioned(
    ...
    quote!(
        ...
        #[derive(iroha_introspect::Introspect, Debug, Clone, iroha_derive::FromVariant, #scale_derives #json_derives)]
        #json_enum_attribute
        pub enum #enum_name {
            #(
